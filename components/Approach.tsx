  ...
  return (
    <section className="w-full py-20 ">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Full-Stack Expertise" icon={<AceternityIcon order="Reason 2"/>}
        description="bring a comprehensive skill set in both front-end and back-end development, allowing me to build robust, scalable applications from start to finish with production-grade code."
        >
          <CanvasRevealEffect
            animationSpeed={4}
        ...
        <Card title="Innovative Problem-Solver" icon={<AceternityIcon order="Reason 3"/>}
        description = "My experience in crafting creative and efficient solutions at the intersection of emerging technologies like blockchain along with and upcoming dev tools sets me apart as a forward-thinking engineer."
        >
          <CanvasRevealEffect
            animationSpeed={3}
